...
public class TelaContatoComercial {
    ...
    private void carregarTabela() {
        ...
        for (ContatoComercial cc : lista) {
            tableModel.addRow(new Object[] {
                    ...
                    cc.getNome(),
                    cc.getEmpresa(),
                    cc.getCidade() != null ? cc.getCidade().getNome() : ""
            });
        }
    }
    ...
    private void salvar() {
        ...
        if (nome.isEmpty() || empresa.isEmpty() || nomeCidade == null || nomeCidade.isEmpty()) {
            JOptionPane.showMessageDialog(frame, "Preencha nome, empresa e cidade.");
            return;
        }
